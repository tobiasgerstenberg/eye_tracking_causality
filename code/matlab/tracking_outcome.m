...
try
    ...
    % GIVE INSTRUCTIONS
    ShowCursor;
    instrimage = imread('instructions3.jpg','jpg');
    ...
    for     k = 1:length(randmovies);       
        ...
        for iteration= 1:2
            ...
            if iteration == 1
                ...
                ShowCursor; %Show mouse cursor
                if outcomes(i) == 0
                    outcomeImage = imread('question_negative.jpg','jpg');
                else
                    outcomeImage = imread('question_positive.jpg','jpg');
                end
                
                Screen('PutImage',win,outcomeImage,[50,y0-100-78,50+923,y0-100+78]);
                Screen('FrameRect', win, [128 128 128], [50,y0-100-78,50+923,y0-100+78],1);
